...
const connection = mongoose.connect('mongodb://maryem:admin@ds149040.mlab.com:49040/toucomex')
...
// Set our api routes
// app.use('/api', api)
app.use('/api', require('./lib/routes/product'))
 ...
 */
server.listen(port, () => console.log(`product Store API running on localhost:${port}`))
